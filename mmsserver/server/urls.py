...
urlpatterns = [
  ...
  path('all_master_tx/', all_master_tx, name="all_master_tx"),
  path('all_profit_tx/', all_profit_tx, name="all_profit_tx"),
  path('all_commission_tx/', all_commission_tx, name="all_commission_tx"),
  path('all_asset_tx/', all_asset_tx, name="all_asset_tx"),
