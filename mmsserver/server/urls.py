...
urlpatterns = [
  ...
  path('user_convert_deposit_tx/', get_convert_deposit_transaction, name='user_convert_deposit_transaction'),
  ...
  path('deposit_master/', deposit_master, name='deposit_master'),
