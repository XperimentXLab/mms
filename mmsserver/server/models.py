...
class OperationalProfit(models.Model):
  daily_profit_rate = models.DecimalField(max_digits=7, decimal_places=4, default=Decimal('0.00'), help_text='Manually update daily profit rate (e.g., enter 5.0 for 5.0%)')
  weekly_profit_rate = models.DecimalField(max_digits=7, decimal_places=4, default=Decimal('0.00'), help_text='Manually update weekly profit rate (e.g., enter 5.0 for 5.0%)')
  current_month_profit = models.DecimalField(max_digits=7, decimal_places=4, default=Decimal('0.00'), help_text='Manually update current month profit (e.g., enter 5.0 for 5.0%)')
