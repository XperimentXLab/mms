  ...
  return (
    <div className="flex flex-col relative">
      ...
      <div className="fixed top-0 left-0 right-0 z-20">
        <header className="flex justify-between items-center py-2 px-3 bg-linear-to-r from-red-600 to-rose-300 bg-linear">
          ...
          <div className="flex items-center gap-4">
            ...
            <img src="./mms.jpg" alt="MMS Logo" className="w-10 h-10 rounded-full" />
